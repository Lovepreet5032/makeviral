...
public class NotificationList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.guestusernotification);
...
//            mViewPager.setBackground(getResources().getDrawable(R.drawable.bg_guest));
//        }
...
//    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            if(position==0) {
                GuestNotificationListFragment fragment = new GuestNotificationListFragment();
                Bundle args = new Bundle();
                //args.putInt(ARG_SECTION_NUMBER, sectionNumber);
                // fragment.setArguments(args);
                return fragment;
            ...
            {
                GuestAdminNotification fragment = new GuestAdminNotification();
                Bundle args = new Bundle();
                //args.putInt(ARG_SECTION_NUMBER, sectionNumber);
                // fragment.setArguments(args);
                return fragment;
        ...
        public CharSequence getPageTitle(int position) {
            switch (position) {
                case 0:
                    return NotificationList.this.getString(R.string.received);
                case 1:
                    return NotificationList.this.getString(R.string.admin);
            }
            return null;
        }
    }
