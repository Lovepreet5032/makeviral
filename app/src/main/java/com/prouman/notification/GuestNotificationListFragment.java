 ...
 */
public class GuestNotificationListFragment extends Fragment {
    /**
    ...
    public GuestNotificationListFragment() {
    }
...
//    }
    ...
    private void getNotification(final boolean showLoading) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ConfigURL.getRecievedNotification, new Response.Listener<String>() {
            @Override
