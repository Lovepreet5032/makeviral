...
/**
 * Created by om on 3/1/2017.
 */
public class AdminNotification extends Fragment implements View.OnClickListener{
    /**
...
//    }
    ...
    ContactDbHandler db;
    AdminNotificationListAdapter adapter;
...
//        }
        ...
        adapter = new AdminNotificationListAdapter(phoneBookList, getActivity());
                       ...
                       /* JSONArray jsonArray = jsonObject.getJSONArray("category");
                        ...
                        for (int j = 0; j < videoArray.length(); j++) {
                            ...
                            if(flag)
                            {
                               ...
                               // model.setStr_isread(phoneBookList.get(pos).getStr_isread());
