...
/**
 * Created by om on 3/15/2017.
 */
public class AdminNotificationListAdapter extends  RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    //int position=0;
    public AdminNotificationListAdapter(List<NotifcationdataObj> mNotifcationList, Context context) {
