...
public class VideoDirectory extends AppCompatActivity {
    ...
    private List<VideoDirectoryData> mVideos;
    ...
    VideoDirectoryAdapter videoViewAdapter;
...
//        mVideoRecyclerView.setAdapter(videoViewAdapter);
    ...
    private void getVideo() {
        ...
        progressDialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ConfigURL.Video_Directory_URL, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                Gson gson=new Gson();
                    VideoDirectoryDataobject dataobject=gson.fromJson(response,VideoDirectoryDataobject.class);
                    if (dataobject.getSuccess().equalsIgnoreCase("true")) {
                      mVideos.addAll(dataobject.getDirectory());
                    }
                    if(progressDialog!=null){
                        progressDialog.hide();}
                    videoViewAdapter = new VideoDirectoryAdapter(mVideos, VideoDirectory.this);
                    mVideoRecyclerView.setAdapter(videoViewAdapter);
