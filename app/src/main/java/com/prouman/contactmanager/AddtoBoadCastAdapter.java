...
public class AddtoBoadCastAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ArrayList<TagDataObject.Broadcast> mNotifcationList;
    ...
    //int position=0;
    public AddtoBoadCastAdapter(ArrayList<TagDataObject.Broadcast> mNotifcationList, Context context,ArrayList<ContactManagerDataObject.ContactManagerListData> data){//,ContactAdapterInterface listner) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder vho, final int pos) {
        if (vho instanceof AddtoBoadCastAdapter.ViewHolder) {
            AddtoBoadCastAdapter.ViewHolder vh = (AddtoBoadCastAdapter.ViewHolder) vho;
            TagDataObject.Broadcast videoPos = mNotifcationList.get(pos);
            vh.bindVideo(videoPos,pos);
        }
        else if(vho instanceof AddtoBoadCastAdapter.EmptyViewHolder)
        {
            ((AddtoBoadCastAdapter.EmptyViewHolder)vho).textView.setText(context.getString(R.string.no_campign));
        }
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        private TagDataObject.Broadcast mVideoModels;
        ...
        public ViewHolder(View v) {
            ...
            txt_listname= (TextView) itemView.findViewById(R.id.txt_listname);
            btn_action = (Button) itemView.findViewById(R.id.btn_action);
        }

        public void bindVideo(TagDataObject.Broadcast videoModel,final int position) {

            mVideoModels = videoModel;
            txt_campignname.setText(mVideoModels.getMsgName());
            txt_listname.setText(mVideoModels.getListName());
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (viewType == EMPTY_VIEW) {
            ...
            AddtoBoadCastAdapter.EmptyViewHolder evh = new AddtoBoadCastAdapter.EmptyViewHolder(v);
            return evh;
        }
        else {
            v = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_addtobroadcast, parent, false);
            AddtoBoadCastAdapter.ViewHolder vh = new AddtoBoadCastAdapter.ViewHolder(v);
            return vh;
        }
    }
