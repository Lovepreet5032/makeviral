...
public class AddtoBroadCast extends AppCompatActivity {
    ProgressDialog progressDialog;
    ArrayList<TagDataObject.Broadcast> arrayListGroup;
    RecyclerView recycler_email;
    ArrayList<ContactManagerDataObject.ContactManagerListData> data;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_addto_broad_cast);
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (contactManagerDataObject.getSuccess().equalsIgnoreCase("true")) {
                        arrayListGroup=contactManagerDataObject.getData().getBroadcasts();
                    ...
                    AddtoBoadCastAdapter addtoCampignAdapter = new AddtoBoadCastAdapter(arrayListGroup, AddtoBroadCast.this,data);
