...
public class GroupListActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new GroupListAdapter(tagDataObjectList, this);
    ...
    public void onClick(View view) {
        switch (view.getId())
        {
            case R.id.btn_composenotification:
                Intent intent=new Intent(GroupListActivity.this,ComposeNotification.class);
    ...
    private void getNotification(final boolean showLoading) {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, ConfigURL.GETGROUPSLIST, new Response.Listener<String>() {
            @Override
...
//                    mVideoRecyclerView.setAdapter(videoViewAdapter);
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(GroupListActivity.this);
