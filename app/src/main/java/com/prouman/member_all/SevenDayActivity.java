 ...
 */
public class SevenDayActivity extends AppCompatActivity implements View.OnClickListener,Spinner.OnItemSelectedListener{
    ...
    private void getStudents(JSONArray j){
        ...
        for(int i=0;i<j.length();i++){
            try {
                ...
                if(formName.equals("Form 7 Day Pack")) {
                    formData.setForm_id(formId);
                    formData.setForm_name(formName);
                    students.add(formData);
                }
                else {
                    AlertDialog.Builder builder1 = new AlertDialog.Builder(SevenDayActivity.this);
